...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-09-2024 a las 07:47:02
...
INSERT INTO `suscripciones` (`id`, `nombre`, `correo`, `telefono`, `fecha_suscripcion`, `cedula`, `password_hash`, `token`, `expira_token`) VALUES
(1, 'yulieth nieto', 'nietoj.1128@gmail.com', '04125267690', '2024-09-07 00:05:38', '29899544', '$2y$10$pw4.8qnY0TM8.TDFgVMaA.3KwFGLrz61dWiHkdQ.BEpGukG8deM/K', NULL, NULL),
(3, 'yulieth nieto', 'coreliznieto@gmail.com', '04125267690', '2024-09-07 00:12:04', '29899544', '$2y$10$77EWfVGvmXXaWKcbUFYzmOQrKuuuw3UUJCXaw30tPpA/jHv9A/ko.', NULL, NULL),
(4, 'jjhsuhkd ijsoasma', 'michelnieto@gmail.com', '04243556748', '2024-09-07 00:19:54', '29899544', '$2y$10$1AWQ2AgcXo1zrKtMwpXYJeSodFU1IgQr.X289.181LP4kpbb2U.TG', NULL, NULL),
(5, 'zddd  ssadsfs', 'miejshs@gmail.com', '04125267690', '2024-09-07 00:22:34', '3373916', '$2y$10$yknqpGK0Q1rNvsmeJXtuOOveHvHxwAti/qqELLPNWtkq6gQqVAb9.', NULL, NULL),
(6, 'juan', 'yostyn_medina@hotmail.com', '04121345204', '2024-09-12 21:38:01', '1234567', '$2y$10$c84UWA2HHKc1/REzlcH/MuTx14Ff3rAcEtfkm7z9YW9IlXnFi11Sy', NULL, NULL),
(7, 'Yostyn', 'yostynmedina550@gmail.com', '04121345204', '2024-09-17 18:06:10', '1234567', '$2y$10$h66Uf/.JciMCNiFoAgmN1eojufEpVBiFOydmgq4iHOtY/gfMxs94u', '883794344bd12a75947d6b30f6c869cb51d24ee685eb7408a7c6bc4799e812db', '2024-09-18 15:59:12');
...
INSERT INTO `usuario` (`idusuario`, `nombre`, `tipo_documento`, `num_documento`, `direccion`, `telefono`, `email`, `cargo`, `login`, `clave`, `imagen`, `condicion`, `token`, `expira_token`) VALUES
(1, 'Admin', 'DNI', '63238', 'Conocido', '27386126', 'admin@gmail.com', '', 'admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', '1725731907.png', 1, NULL, NULL);
...
--
ALTER TABLE `venta`
  ADD CONSTRAINT `fk_venta_persona` FOREIGN KEY (`idcliente`) REFERENCES `persona` (`idpersona`) ON DELETE CASCADE,
