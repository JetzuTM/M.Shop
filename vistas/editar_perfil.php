...
<head>
    ...
    <title>Perfil de Usuario - Tienda de Regalos</title>
...
<body>
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center bg-purple text-white py-5">
                        <?php
                        $imagen_perfil = isset($user_data['imagen_perfil']) && !empty($user_data['imagen_perfil']) ? $user_data['imagen_perfil'] : './assets/img/150.png';
                        ?>
                        <img src="<?php echo htmlspecialchars($imagen_perfil); ?>" alt="avatar" class="rounded-circle img-fluid perfil-image" style="width: 150px;">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <h2 class="text-purple mb-4">Subir Imagen de Perfil</h2>
                        <form method="POST" action="subir_imagen.php" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-purple">Subir Imagen</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <a href="escritorio_tienda.php" class="btn btn-purple mt-3">Volver</a>
        </div>
    </div>
