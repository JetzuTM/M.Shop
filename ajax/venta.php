...
switch ($_GET["op"]){
	...
	case 'listarDetalle':
		...
		echo '<tfoot>
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th><h4 id="total">BsD/.'.$total.'</h4><input type="hidden" name="total_venta" id="total_venta"></th> 
                                </tfoot>';
	break;
	...
	case 'selectCliente':
		...
		if (isset($rspta['personas']) && !empty($rspta['personas'])) {
			foreach ($rspta['personas'] as $reg) {
